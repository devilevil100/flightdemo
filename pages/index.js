...
export async function getStaticProps() {
  const exploreData = await fetch("https://www.jsonkeeper.com/b/UMTE").then(
    (res) => res.json()
  );

  const liveAnywhere = await fetch("https://www.jsonkeeper.com/b/VHHT").then(
    (res) => res.json()
  );
  const discoverExpCard = await fetch("https://www.jsonkeeper.com/b/UELS").then(
    (res) => res.json()
  );
  return {
